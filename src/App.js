...
function App() {
 ...
 <Col span={8}>
    <Card title="Task Creation" bordered={false} style={{ width: 650, backgroundColor:"#b6d8f4" }}>
       <div >
       <Form 
       form={form}  onFinish={onFinish} name="basic"labelCol={{ span: 8 }}wrapperCol={{ span: 16 }}style={{ maxWidth: 600}}
...
<option value="Vault Secure Planner">Vault Secure Planner</option>
     ...
     <Form.Item >
       ...
       <Button type='primary'htmlType="button" onClick={ onReset}>Cancel</Button>
       </Space>
